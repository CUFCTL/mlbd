...
Students who are taking the CI as an ECE technical elective (or Honors credit) are required to do two things in addition to the semester report:
- __Present their work__ to the group during the last meeting.
- Submit a __Jupyter notebook__ of their project such that anyone can reproduce their results.
